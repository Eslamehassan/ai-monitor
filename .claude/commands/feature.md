...
- Create the plan in the `.worklog/specs/active/*.md` file. Name it appropriately based on the `Feature`.
...
- `backend/**` - Contains the codebase backend.
- `frontend/**` - Contains the codebase frontend.
- `hooks/**` - Contains the codebase hooks.
- `services/**` - Contains the codebase services.
